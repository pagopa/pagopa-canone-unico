...
public class IuvCodeGenerator {
     ...
     * Private constructor
     *
     * @param builder builder for instance generation
     */
    ...
    public static class Builder {
         ...
         * Set the auxDigit
         *
         * @param auxDigit numeric value that defines the structure of the IUV code
         ...
         *
         * @param segregationCode numerical value associated with each point of generation
         *                        of the IUV code.<br/>
