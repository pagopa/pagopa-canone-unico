...
public class CuCsvService {
    ...
    private final String containerInputBlob = System.getenv("INPUT_CSV_BLOB");
    private final String containerErrorBlob = System.getenv("ERROR_CSV_BLOB");
    private final String debtPositionTable = System.getenv("DEBT_POSITIONS_TABLE");
    private final String debtPositionQueue = System.getenv("DEBT_POSITIONS_QUEUE");
